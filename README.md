...
🌱 I can build websites and web applications in React to solve real world Business problems.Apart from React I am also building projects in JavaScript,MERN stack,TypeScript,React Native,Vue.Other skills on my bucket list for the next few months are GraphQL,NextJS,Java,Figma,Photoshop and Scuba Diving.

👩‍🍳 Being a person with multiple hobbies,creativity flows through my veins.As a developer I like to mix different technologies and create different recipes.
